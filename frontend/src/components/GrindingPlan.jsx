                    ...
                    return (
                        <div key={sys.system_id} style={{
                            ...
                            <div style={{ display: 'flex', gap: 4, marginTop: 2 }}>
                                <span style={{ fontSize: 8, padding: '0 3px', borderRadius: 2, background: hasMilitary ? 'rgba(255,102,119,0.15)' : 'rgba(255,51,85,0.05)', border: `1px solid ${hasMilitary ? 'rgba(255,102,119,0.4)' : 'rgba(255,51,85,0.15)'}`, color: hasMilitary ? '#ff6677' : '#552233' }} title={hasMilitary ? `${summary.military} military upgrade(s)` : 'No military upgrades — rat here'}>MIL {hasMilitary ? summary.military : '—'}</span>
                                <span style={{ fontSize: 8, padding: '0 3px', borderRadius: 2, background: hasIndustry ? 'rgba(0,255,136,0.1)' : 'rgba(0,255,136,0.03)', border: `1px solid ${hasIndustry ? 'rgba(0,255,136,0.3)' : 'rgba(0,255,136,0.1)'}`, color: hasIndustry ? '#00ff88' : '#224433' }} title={hasIndustry ? `${summary.industry} industry upgrade(s)` : 'No industry upgrades — mine here'}>IND {hasIndustry ? summary.industry : '—'}</span>
