...
export const MAP_LAYOUT_SUBWAY = {
...
export const MAP_CONNECTIONS = [
    ...
    // ===== S4S-SD regional =====
    ["L-GY1B", "AID-9T", "regional"],
    ["O31W-6", "7-YHRX", "regional"],
    ["B1UE-J", "V3P-AZ", "regional"],

    // ===== 3NA-Z1 internal (7 gates) =====
    ["EPCD-D", "L-TLFU", "internal"],
    ...
    // ===== 2O-VY7 regional =====
    ["A-YB15", "FB-MPY", "regional"],
    ["SY-0AM", "J7M-3W", "regional"],
    ["QZX-L9", "Z-EKCY", "regional"],
    ...
    ["L-TOFR", "9-GBPD", "regional"],
];

export const LAWN_SYSTEMS = ["UDVW-O", "UJXC-B", "F48K-D", "1-KCSA", "XTJ-5Q", "JT2I-7", "N-JK02", "FB5U-I", "BZ-BCK", "J-OAH2", "O5-YNW", "86L-9F", "5-VFC6", "IUU3-L", "S-LHPJ"];
export const BORDER_SYSTEMS = ["UDVW-O", "N-JK02", "1S-SU1", "L-GY1B", "FZX-PU", "A-YB15", "SY-0AM", "B1UE-J", "O31W-6", "QZX-L9"];
